...
function drawGame1() {
  ...
  text("You are a brave knight", width / 2, 160);
  ...
  drawGame1Button(game1Btn);

  // ---- Cursor feedback ----
  // If the mouse is over the button, show a hand cursor
  // Otherwise, show the normal arrow cursor
  cursor(isHover(game1Btn) ? HAND : ARROW);
}
...
function drawGame1Button({ x, y, w, h, label }) {
  rectMode(CENTER);
